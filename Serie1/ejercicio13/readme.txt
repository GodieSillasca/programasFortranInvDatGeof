...
# SERIE 1
#  
# Archivo 'readme.txt' del ejercicio 13 de la serie 1.
#
# Integrantes:
...
para la ejecución del script principal:
   ...
   e. genMat13.f08 (dentro de generacionMatriz)
...
Para mayores referencias respecto a la ejecución y los comandos utilizados para la misma revisar
el archivo 'exe.sh' ubicado en la carpeta 'ejercicio13' a la misma altura de este documento.
...
del directorio 'generacionMatriz' (genMat13.f08) y se encarga de generar el archivo de texto con la
matriz que representa el sistema de ecuaciones planteado para este ejercicio. El segundo programa
en ejecutarse (Pr_13.f08) lee el archivo de texto generado por el programa anterior (o sea, lee la 
...
a. La matriz generada se almacena en el documento llamado mat13.dat y se encuentra en el directorio
   'ejercicio13' a la misma altura de este documento.
...
c. Los documentos están nombrados de la siguiente manera, dependiendo del método numérico usado:
		...
		* Matriz inversa de la matriz 'a' ---> '*_matInv13.dat'
...
d. El tiempo de ejecución para calcular la matriz inversa se especifica en el archivo
   ...
   el directorio 'ejercicio13' a la misma altura de este documento.
