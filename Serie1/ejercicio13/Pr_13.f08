...
program Pr_13
   ...
   call writeMat('resultados/LU/LU_matInv13.dat', InvA)
   ...
   call writeMat('resultados/jacobi/jacobi_matInv13.dat', InvA)
   ...
   call writeMat('resultados/gauss_seidel/gaussSeid_matInv13.dat', InvA)
   ...
   call writeMat('resultados/SOR/SOR_matInv13.dat', InvA)
   ...
   call writeMat('resultados/elim_gauss/elim_gauss_matInv13.dat', InvA)
