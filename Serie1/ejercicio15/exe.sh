...
# SERIE 1
#  
# Script para la ejecución del ejercicio 15 de la serie 1.
#
# Integrantes:
...
#                 LEER EL ARCHIVO 'readme.txt' PARA INSTRUCCIONES MÁS COMPLETAS
...
gfortran ../modRW.f08 generacionMatriz/genMat15.f08 -o exe
./exe
rm exe modrw.mod

#Compilación y ejecución de la generación del programa principal
gfortran -O3 ../NumKind.f08 ../modSEL.f08 ../modRW.f08 Pr_15.f08 -o exe
./exe
rm exe modrw.mod modsel.mod numkind.mod

echo '¡Programas compilados y ejecutados correctamente!'
echo 'Revisar el archivo "readme.txt" para revisar los resultados.'
