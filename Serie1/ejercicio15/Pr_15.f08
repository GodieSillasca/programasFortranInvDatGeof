...
program Pr_15
   ...
   call writeMat('resultados/LU/LU_matInv15.dat', InvA)
   ...
   call writeMat('resultados/jacobi/jacobi_matInv15.dat', InvA)
   ...
   call writeMat('resultados/gauss_seidel/gaussSeid_matInv15.dat', InvA)
   ...
   call writeMat('resultados/SOR/SOR_matInv15.dat', InvA)
   ...
   call writeMat('resultados/elim_gauss/elim_gauss_matInv15.dat', InvA)
