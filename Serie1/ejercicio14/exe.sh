...
# SERIE 1
#  
# Script para la ejecución del ejercicio 14 de la serie 1.
#
# Integrantes:
...
gfortran ../modRW.f08 generacionMatriz/genMat14.f08 -o exe
./exe
rm exe modrw.mod

#Compilación y ejecución de la generación del programa principal
gfortran ../NumKind.f08 ../modSEL.f08 ../modRW.f08 Pr_14.f08 -o exe
./exe
